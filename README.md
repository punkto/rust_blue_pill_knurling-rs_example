# Example of knurling-rs application with embedded tests for the Blue Pill (stm32f104 - Cortex m3)
Generated from:
https://github.com/knurling-rs/app-template

Configurated to be used with a Blue Pill board connected to the host using a STLink V2:
```
$ probe-rs list
The following debug probes were found:
[0]: STLink V2 -- 0483:3748:60 (ST-LINK)
...
I have added some tests to learn how to use [defmt](https://github.com/knurling-rs/defmt/tree/main/defmt) and [defmt-test](https://github.com/knurling-rs/defmt/tree/main/firmware/defmt-test)

Some command examples that you can check:
```
cargo run --bin hello
cargo rb hello --verbose # "rb" is the same as "run --bin"
cargo rb levels --verbose
DEFMT_LOG=trace cargo rb levels
DEFMT_LOG=trace cargo rb format
DEFMT_LOG=trace cargo rb overflow
cargo test --lib
cargo test
cargo test --test integration
cargo test --test lib_hello
```

# Original knurling-rs/app-template README.md
